...
export AWS_EKS_CLUSTER_NAME='seqera-platform'
...
export AWS_EKS_INSTANCE_TYPE='m5a.2xlarge'

# The AWS S3 bucket name that will store the Terraform state
export AWS_TF_STATE_BUCKET='seqera-platform-tf-state'

# The AWS S3 path that will store the Terraform state
export AWS_TF_STATE_KEY='state'
